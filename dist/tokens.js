...
const T = {
  color: {
    ...
    // to install (coral)
    yellow: '#F5C24B',
    // current sequence (gold-yellow)
    pink: '#FF6FB5',
    // next pour (pink)
    blue: '#4FA3F2',
    // has knife plate (cyan-blue)
    ...
    onAccent: '#0A0B16',
    // text on accent
    line: 'rgba(150,166,210,0.16)',
    // hairline divider on dark
    lineSoft: 'rgba(150,166,210,0.10)'
  },
  font: {
    display: "'Rajdhani', 'Saira Condensed', sans-serif",
    // futuristic display
...
const TEX = {
  grain: "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='120' height='120'><filter id='n'><feTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='2' stitchTiles='stitch'/><feColorMatrix type='saturate' values='0'/></filter><rect width='120' height='120' filter='url(%23n)' opacity='0.5'/></svg>\")",
...
const steelPlate = (a = '#1A2230', b = '#11151C') => `linear-gradient(155deg, ${a} 0%, ${b} 70%)`;
